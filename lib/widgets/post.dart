...
import 'package:petsgram/pages/comments.dart';
import 'package:petsgram/pages/home.dart';
import 'package:petsgram/widgets/custom_image.dart';
...
// Only for Post woner
  deletePost() async {
    ...
    // Delte activity feed
    QuerySnapshot activityFeedSnapshot = await activitiyFeedRef
        .document(ownerId)
  ...
  addLiketoActivityFeed() async {
    // Notification only when activity done by other users
    bool isNotPostOwner = currentUserId != ownerId;
    if (isNotPostOwner) {
      await activitiyFeedRef
          .document(ownerId)
          .collection("feedItems")
          .document(postId)
          .setData({
